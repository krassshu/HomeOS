...
## Autorstwo i ślady narzędzi

28. Nie podpisuj się nigdzie w projekcie ani w generowanych plikach.

29. Nie dodawaj informacji sugerujących, że kod lub pliki zostały utworzone
    albo zmodyfikowane przez AI, Claude, Claude Code, Anthropic lub inne
    narzędzie. W szczególności:
    - żadnych adnotacji „Generated by …”, „AI-generated” ani podobnych,
    - żadnych `Co-Authored-By`, podpisów ani informacji o narzędziu w commitach,
    - żadnych komentarzy w kodzie o użyciu AI,
    - żadnych plików README, CHANGELOG, metadata ani innych tworzonych tylko
      po to, aby zaznaczyć udział narzędzia,
    - żadnego imienia, nazwy modelu ani nazwy narzędzia w kodzie, konfiguracji,
      komentarzach, logach lub dokumentacji,
    - żadnych elementów UI, footerów, badge'y, watermarków ani tekstów
      wskazujących na użycie AI.

30. Nie zmieniaj istniejących informacji o autorze projektu bez wyraźnego
    polecenia.

31. Wprowadzaj wyłącznie zmiany potrzebne do wykonania zadania. Efekt końcowy
    ma wyglądać jak zwykła część istniejącego projektu, bez dodatkowych
    podpisów, oznaczeń lub śladów narzędzia.
